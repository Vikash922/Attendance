...
object CloudSyncService {
    ...
    var lastSyncTime: String = SimpleDateFormat("MMM dd, yyyy hh:mm a", Locale.US).format(Date())
    ...
    suspend fun enforceMandatoryMetadata(
        ...
        return try {
            ...
            val timeStr = SimpleDateFormat("MMM dd, yyyy hh:mm a", Locale.US).format(Date())
